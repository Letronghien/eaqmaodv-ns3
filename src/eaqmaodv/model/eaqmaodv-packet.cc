...
{
    static TypeId tid = TypeId("ns3::eaqmaodv::TypeHeader")
                            .SetParent<Header>()
...
{
    static TypeId tid = TypeId("ns3::eaqmaodv::RreqHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::eaqmaodv::RrepHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::eaqmaodv::RrepAckHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eaqmaodv")
...
{
    static TypeId tid = TypeId("ns3::eaqmaodv::RerrHeader")
                            .SetParent<Header>()
                            .SetGroupName("Eaqmaodv")
